...
const AddTransactionView=(props)=>{
     ...
     const [type,setType]=useState("EXPENSE");
      const addTransaction=()=>{
        ...
        props.toggleAddTxn((state)=>{console.log(state);return !state});
      };
    return (
   ...
   const [isAddTxnVisible,toggleAddTxn]=useState(false);
    return (
        <Container>
         ...
         <AddTransaction onClick={()=>toggleAddTxn(!isAddTxnVisible)}>{isAddTxnVisible? "Cancel":"ADD"}</AddTransaction></BalanceBox>
